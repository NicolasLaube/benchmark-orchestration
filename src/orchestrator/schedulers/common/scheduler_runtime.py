...
from orchestrator.monitoring.logger_rich.rich_progress_view import RichProgressView
from orchestrator.report.report_models import QuestionResult
from orchestrator.schedulers.common.scheduler_metrics import SchedulerMetrics
from orchestrator.schedulers.common.scheduler_models import AttemptOutcome
from orchestrator.schedulers.common.scheduler_types import (
    EventLogger,
    ProgressView,
    ProgressViewFactory,
)
...
class SchedulerRuntime:
    ...
    def __init__(
        ...
        *,
        ...
        # The pause_until timestamp indicates when the scheduler can resume processing after a global
    ...
    def compute_retry_delay(
        ...
        *,
        ...
        Args:
            outcome (AttemptOutcome): The outcome of the attempt for which to compute the retry delay.
