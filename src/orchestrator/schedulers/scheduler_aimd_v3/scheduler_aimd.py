...
from orchestrator.schedulers.scheduler_aimd_v3.scheduler_aimd_outcomes import (
    handle_outcome,
)
...
class AdaptiveAimdScheduler:
    def __init__(
        ...
        config: AdaptiveAimdConfig | None = None,
        **runtime_kwargs,
    ) -> None:
        self.config = config or AdaptiveAimdConfig()
