...
from orchestrator.schedulers.common.scheduler_observability import (
    log_final_summary,
    maybe_log_progress,
)
from orchestrator.schedulers.common.scheduler_runtime import SchedulerRuntime
from orchestrator.schedulers.scheduler_fixed_v2.scheduler_fixed_config import (
...
class FixedConcurrencyScheduler:
    def __init__(
        ...
        config: FixedConcurrencyConfig | None = None,
        **runtime_kwargs,
    ) -> None:
        self.config = config or FixedConcurrencyConfig()
